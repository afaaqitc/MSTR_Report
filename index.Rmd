...
knitr::include_graphics("/home/jdrk/Documents/MSTR/Picture1.png")
```
...
knitr::include_graphics("/home/jdrk/Documents/MSTR/MSTR/20241211105452.png")

```
---

```{r,out.width="10%",fig.align='center',echo=FALSE,message=FALSE,warning=FALSE}
knitr::include_graphics("/home/jdrk/Documents/MSTR/MSTR/Untitled 1 (copy).png")
```
